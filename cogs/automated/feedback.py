...
class Feedback(commands.Cog):
    ...
    @cog_ext.cog_slash(name="feedback",
    ...
    async def feedback(self, ctx, responce: str):
      hook = Webhook('https://discord.com/api/webhooks/836672592294576158/rMr69PZ8I7uNYhxMS_7zO1Oay29u7OZ1T7Rj_tI2oQ1mklpqC8JypUfUHcSekLUWRzVq')
